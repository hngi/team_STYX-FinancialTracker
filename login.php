    ...
    <body>
        <div class="row">
            <div class="vec col-md-6">
                <h5 class="text-center green-text" style="color: #071739;">Be in charge of your money</h5>
                <p class="text-center" style="color: #071739;">Create a new Styx finance account and take charge</p>
                <img src="images/background.png">
            </div>
       
            <div class="col-12 col-sm-12 col-md-6 main">
                <p style="color: white; font-size: 25px; margin-top: -20px;" class="home_button"><a href="index.php" style="color: white;"><i class="fas fa-home"></i></a></p>

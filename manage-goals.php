            ...
            <div class="goal-container">
                ...
                <div class="current-goal">
                    <form >
                        ...
                        <input type="button" value="Add Goal" class="btn btn-info" onclick="addGoal()">

                        <section >
                                <h3> Current Goal Statistics</h3>
                                <div class="addAmount"> 
                                    <input type="number" placeholder="Enter Amount" id="addAmount" value="">
                                    <input type="button" value="Add amount" style="width: 150px" class="addAmount-btn" onclick="plusAmount ()"> </div>
                                <p>
